...
public:
	...
	inline void setFrameInterval(int interval) {glfwSwapInterval(interval);}
	...
	inline void setIcon(const GLFWimage& icon) { glfwSetWindowIcon(window, 1, &icon); }
	...
	inline void display() { glfwSwapBuffers(window);}
